...
- (void)onSendSearchWifiHardDevice:(id)arg1;
...
- (void)onSendWCDeviceBindUnauthResponse:(id)arg1 Error:(id)arg2;
- (void)onSearchUnauthDeviceResponse:(id)arg1 ErrorCode:(int)arg2;
...
- (void)c2objc_onReceiveWCLanDeviceDisc:(id)arg1 Cmd:(unsigned int)arg2 data:(struct AutoBuffer *)arg3;
...
- (void)tryUploadM7OrHealthKitStepCount:(_Bool)arg1;
- (void)stopScanWCLanDevice;
- (void)startScanWCLanDevice;
- (void)releaseWCLanDeviceLib;
- (void)initWCLanDeviceLib;
...
- (void)sendSearchUnauthDeviceReq:(id)arg1;
...
- (void)sendWCDeviceBindUnauthRequest:(id)arg1;
