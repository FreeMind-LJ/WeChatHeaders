...
@class MMTipsViewController, NSString, RichTextView, UIButton, UITextField, WCPayMoneyTextFieldItem;

@interface WCPayTransferMoneyViewController : WCPayBaseViewController <MMTipsViewControllerDelegate, ILinkEventExt, UITextFieldDelegate>
{
