...
- (void)GetHistoryTransferOrderDetailInfo:(id)arg1 TransferID:(id)arg2;
- (void)GetHistoryOrderDetailInfo:(id)arg1 PayType:(int)arg2;
- (void)SetAllReadFlagNotifyMsg;
- (void)SetReadFlagNotifyMsg:(id)arg1;
- (void)DeleteAllNotifyMgs;
- (void)DeleteNotifyMsg:(id)arg1;
- (id)GetNotifyMsgByCreateTime:(unsigned int)arg1 LaterTime:(unsigned int)arg2;
