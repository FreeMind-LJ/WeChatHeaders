...
+ (id)parseGameRankInfoListWithDictionary:(id)arg1;
+ (id)parseGameRankInfoWithDictionary:(id)arg1;
+ (id)parseGameResourceListWithDictionary:(id)arg1;
+ (id)parseHomepageDataWithResp:(id)arg1;
+ (id)parseHomepageDataWithJSONString:(id)arg1;
...
+ (id)getGameCenterMsgTipsPath;
+ (id)getGameCenterDBPath;
