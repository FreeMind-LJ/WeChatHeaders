...
- (void)onVerifyPurchaseForPurchase:(id)arg1 request:(id)arg2;
- (void)finishTransactionForTransactionID:(id)arg1;
- (_Bool)FinishTransaction:(id)arg1;
- (_Bool)RecoverTransactions;
...
- (void)verifyTransationForUnVerifyTransaction:(id)arg1 verifyType:(int)arg2;
