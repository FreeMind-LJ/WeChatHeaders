...
@class CMessageWrap, MMAnimationTipView, MMProgressView, NSString, UILabel, UIView, WCActionSheet;

@interface AppEmoticonPreviewViewController : MMUIViewController <WCActionSheetDelegate, EmoticonBackupOperateMgrExt, IMsgExt, IMsgRevokeExt, UIAlertViewDelegate>
{
...
@property(retain, nonatomic) MMAnimationTipView *_tipView; // @synthesize _tipView;
