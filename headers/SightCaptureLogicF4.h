...
- (unsigned int)startRecordF4:(struct CGSize)arg1 bitRate:(int)arg2 needCompress:(_Bool)arg3;
...
- (unsigned int)prepareRecordF4:(struct CGSize)arg1 bitRate:(int)arg2 needCompress:(_Bool)arg3;
