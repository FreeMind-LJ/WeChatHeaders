...
- (void)NotifyNoShareEnterpriseRedEnvelopesRequest:(id)arg1;
- (void)OpenAtomicEnterpriseRedEnvelopesRequest:(id)arg1;
- (void)ReceiveAtomicEnterpriseRedEnvelopesRequest:(id)arg1;
- (void)SendShareEnterpriseRedEnvelopesoRequest:(id)arg1;
- (void)OpenEnterpriseRedEnvelopesRequest:(id)arg1 SendKey:(id)arg2;
...
- (void)GetEnterpriseHongbaoBusinessRequest:(id)arg1 CMDID:(unsigned int)arg2 SendKey:(id)arg3 OutputType:(unsigned int)arg4;
