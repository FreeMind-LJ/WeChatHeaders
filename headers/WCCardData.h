...
@property(nonatomic) unsigned int uiLayoutType; // @synthesize uiLayoutType;
...
- (void)parseShareInfoDic:(id)arg1;
- (void)parseCardInfoDic:(id)arg1;
- (void)parseCardTPInfoDic:(id)arg1;
