...
@class ChatMigrationBackupChatDB, NSMutableDictionary, NSRecursiveLock;
...
@interface ChatMigrationBackupChatFileHelper : NSObject
{
    ...
    unsigned int uiCurReportMsgCount;
}

- (void).cxx_destruct;
- (id)getNextPackage:(id)arg1;
- (unsigned long long)getSessionCount:(id)arg1;
- (unsigned long long)getTotalCount:(id)arg1;
