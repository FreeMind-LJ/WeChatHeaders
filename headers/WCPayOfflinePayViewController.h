...
@class MMUIView, MMWebImageView, NSArray, NSObject<OS_dispatch_queue>, NSString, RichTextView, UIAttachmentBehavior, UIButton, UIDynamicAnimator, WCPayOfflinePayCodeView, WCPayOfflineUpdatedTipsView, WCPayPickerView;

@interface WCPayOfflinePayViewController : WCPayBaseViewController <WCPayOfflinePayCodeViewDelegate, UIGestureRecognizerDelegate, MMKernelExt, MMPatternLockLogicDelegate, IdleTimerUtilExt, WCActionSheetDelegate, ILinkEventExt, UIAlertViewDelegate, WCMallAcrivityLoopPageScrollViewDataSourceDelegate, WCPayPickerViewDelegate, WCPayLogicMgrExt>
{
