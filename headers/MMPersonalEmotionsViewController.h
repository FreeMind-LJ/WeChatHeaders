...
@class EmotionCollectionFooterView, LoopPageScrollView, NSMutableArray, NSString, NSTimer, UICollectionView, UICollectionViewFlowLayout, UIView;

@interface MMPersonalEmotionsViewController : MMUIViewController <UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, EmoticonStoreMgrExt, EmoticonBoughtListMgrExt, LoopPageScrollViewDataSourceDelegate, EmoticonStoreCellDelegate, EmotionCollectionFooterViewDelegate>
{
