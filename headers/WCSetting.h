...
@interface WCSetting : NSObject <NSCoding>
{
    ...
    int introTipShowCountForVideoAd;
    int groupTransferCount;
}

@property(nonatomic) int introTipShowCountForVideoAd; // @synthesize introTipShowCountForVideoAd;
...
- (void).cxx_destruct;
- (_Bool)shouldShowIntroTipForVideoAd;
