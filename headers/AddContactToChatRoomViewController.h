...
@interface AddContactToChatRoomViewController : MMUIViewController <WCActionSheetDelegate, NewChatRoomMemberItemViewDelegate, IContactMgrExt, CreateChatLogicDelegate, contactInfoDelegate, UIAlertViewDelegate>
{
    CContact *m_contact;
