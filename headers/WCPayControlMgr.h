...
- (_Bool)isHtml5Wallet;
- (_Bool)needCheckUserRegisteredForPayU;
- (_Bool)USER_PAYU;
- (unsigned int)startOpenTouchIDAuthLogic:(id)arg1 Data:(id)arg2 Action:(unsigned long long)arg3;
- (unsigned int)startSecurityQuestionLogic:(id)arg1 Data:(id)arg2;
- (unsigned int)startOpenHtml5WalletLogic:(id)arg1 data:(id)arg2;
- (unsigned int)startOpenWalletLogic:(id)arg1 Data:(id)arg2;
...
- (void)jsGetPaymentOrderRequest:(id)arg1;
