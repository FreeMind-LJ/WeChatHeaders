...
@class ContactsSelectorController, EmoticonBoardView, MMGrowTextView, MMLoadingView, MMScrollView, MMTableViewInfo, NSObject, NSString, NSTimer, RoundTableViewCell, UIButton, UIImageView, UILabel, UIView, WCDataItem, WCEditMemberPannel, WCInputController, WCLocationInfo, WCSelectorView, WCTimelinePOIPickerViewController;

@interface WCForwardViewController : MMUIViewController <ContactsSelectorControllerDelegate, UIScrollViewDelegate, scrollViewDelegate, UITextViewDelegate, SelectorControllerDelegate, MMTableViewInfoDelegate, UIAlertViewDelegate, IMsgExt, WCFacadeExt, IMMGrowTextViewExt, WCTimelinePOIPickerViewControllerDelegate>
{
