...
@interface WCPayPayUReveiverControlTransferControlLogic : WCPayControlLogic <WCPayTransferMoneyStatusViewControllerDelegate>
{
}

- (void)OnTransferQueryStatusResponseStatus:(id)arg1 Error:(id)arg2;
- (void)OnTransferCancelResponseStatus:(id)arg1 Error:(id)arg2;
- (void)OnTransferConfirmResponseStatus:(id)arg1 Error:(id)arg2;
- (void)ToRefusedMoney;
