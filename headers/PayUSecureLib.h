...
@class PayUDelegate, PayUTPIDKeyboardView, UIView;

@interface PayUSecureLib : UITextField
{
    PayUDelegate *myDelegate;
    int nMaxLen;
    UIView *myKeyboard;
    PayUTPIDKeyboardView *myiPadKeyboard;
    _Bool bFormatBankCard;
    id <PayUSecureCtrlDelegate> ctrlDelegate;
}

@property(nonatomic) _Bool bFormatBankCard; // @synthesize bFormatBankCard;
@property(nonatomic) id <PayUSecureCtrlDelegate> ctrlDelegate; // @synthesize ctrlDelegate;
- (void)setDefaultValue:(id)arg1;
- (_Bool)isAreaIDCardNum:(long long)arg1;
- (_Bool)isUserIDNum;
- (_Bool)isBankCardNum;
- (_Bool)isPhoneNum;
- (id)GetOriginalDataNotFilter;
- (id)GetOriginalData;
- (id)GetRsaEncryptData:(int)arg1 HashMethodType:(int)arg2;
- (void)ClearInput;
- (void)SelectRsaKey:(int)arg1;
- (void)SetIgnoAnyInput:(_Bool)arg1;
