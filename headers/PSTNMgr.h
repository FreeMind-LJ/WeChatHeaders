...
@class AUAudioDevice, NSRecursiveLock, NSString, NSTimer, PSTNComponent, PSTNDialData;
...
@interface PSTNMgr : MMService <INetworkStatusMgrExt, MMService>
{
    ...
    NSTimer *mPSTNHeartbeatTimer;
    NSTimer *mPSTNDialStatusTimer;
}
...
@property(retain, nonatomic) NSTimer *mPSTNDialStatusTimer; // @synthesize mPSTNDialStatusTimer;
@property(retain, nonatomic) NSTimer *mPSTNHeartbeatTimer; // @synthesize mPSTNHeartbeatTimer;
