...
- (void)OnMessageReturnInPayUGenPrepay:(id)arg1 Event:(unsigned int)arg2;
- (void)OnMessageReturnInPayUCommon:(id)arg1 Event:(unsigned int)arg2;
...
- (void)WCPayPayUGenPrepay:(id)arg1;
...
- (void)WCToPayUCommonRequest:(id)arg1 RetryCount:(unsigned int)arg2;
