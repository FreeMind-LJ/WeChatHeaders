...
@class MMUILabel, NSArray, NSString, UIButton, UIPopoverController;

@interface MMScrollActionSheet : UIView <MMScrollActionSheetIconViewDelegate, UIScrollViewDelegate>
{
