...
@class NSString, NSTimer, UIView, VoipDescriptionButton;
...
@interface VideoVoipCallerView : VideoVoipView <IRecordPermissionCheckExt, UIAlertViewDelegate>
{
    ...
    NSTimer *m_notOnlineTimer;
    NSTimer *m_actingTimer;
}
...
@property(retain, nonatomic) NSTimer *m_actingTimer; // @synthesize m_actingTimer;
@property(retain, nonatomic) NSTimer *m_notOnlineTimer; // @synthesize m_notOnlineTimer;
