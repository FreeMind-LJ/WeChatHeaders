...
- (void)callAllExtWithOrder:(id)arg1 Data:(id)arg2 UrlMd5:(id)arg3;
- (void)callImageDidLoadOrFailedExt:(id)arg1 UrlMd5:(id)arg2;
- (_Bool)callImageDidLoadWithDataOrFailedExt:(id)arg1 withUrlMd5:(id)arg2;
- (void)callImageDidLoadWithDataExt:(id)arg1 withUrlMd5:(id)arg2;
- (void)callImageDidLoadExt:(id)arg1 withUrlMd5:(id)arg2;
