...
@class CContact, MMCPLabel, MMHeadImageView, MMWebImageView, NSString, UIButton, UIImageView, UILabel;
...
- (void)showChatRoomCount:(id)arg1 withSessionSelectType:(int)arg2;
