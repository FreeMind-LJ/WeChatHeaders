...
@interface SightCaptureLogicWithoutGL : MMObject <SightMovieWriterDelegate, SightCaptureLogic, MMovieCompressorDelegate>
{
...
- (unsigned int)prepareRecord:(struct CGSize)arg1 bitRate:(int)arg2;
- (unsigned int)prepareHighQualityRecord:(struct CGSize)arg1;
...
- (unsigned int)startRecordF2:(struct CGSize)arg1 bitRate:(int)arg2 needCompress:(_Bool)arg3;
- (unsigned int)startHighQualityRecord:(struct CGSize)arg1;
- (unsigned int)startRecord:(struct CGSize)arg1 bitRate:(int)arg2;
