...
@class DropdownMenu, GameCenterLoadingFooterView, GameCenterSearchLogicController, GameLibraryAppInfo, LoopPageScrollView, MMHorizontalTableView, MMLoadingView, MMTableView, NSMutableArray, NSMutableDictionary, NSString, NSTimer, UIButton, UIPageControl, UIView;
