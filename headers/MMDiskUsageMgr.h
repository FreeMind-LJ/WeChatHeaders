...
@class MMDiskUsageConfigHandler, MMDiskUsageReporter, MMDiskUsageScaner, MMDiskUsageStatus, NSObject<OS_dispatch_queue>, NSString, NSTimer;
...
@interface MMDiskUsageMgr : MMService <MMDiskUsageScannerDelegate, MMDiskUsageRepoterDelegate, ReportStrategyExt, MMService>
{
    ...
    NSTimer *m_timerStartScan;
    NSTimer *m_timerStopScan;
...
@property(retain, nonatomic) NSTimer *m_timerStopScan; // @synthesize m_timerStopScan;
@property(retain, nonatomic) NSTimer *m_timerStartScan; // @synthesize m_timerStartScan;
