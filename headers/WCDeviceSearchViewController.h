...
@class MMLoadingView, MMTableView, NSMutableArray, NSString, UILabel, UIView, WCDevice, WCDeviceSearchLogic;
...
- (void)onGetHardDeviceHelpUrl:(id)arg1 device:(id)arg2;
...
- (id)initWithFilterUserData:(id)arg1 scene:(unsigned long long)arg2;
- (id)init;
