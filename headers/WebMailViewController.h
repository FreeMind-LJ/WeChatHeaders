...
@class CMail, MMTableView, MailAttachmentControlView, MailContactFilterView, MailReceiverEditView, MailSubjectEditView, NSMutableArray, NSString, NSTimer, UIResponder, UIView, UIWebView;
