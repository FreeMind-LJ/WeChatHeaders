...
@class EmoticonStoreCollectionCellData, NSArray, NSString, PersonalDesigner, SKProduct, iAPTransation;
...
@property(retain, nonatomic) EmoticonStoreCollectionCellData *m_collectionData; // @synthesize m_collectionData;
@property(nonatomic) _Bool m_isCollectionCell; // @synthesize m_isCollectionCell;
