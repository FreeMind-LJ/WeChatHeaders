...
@interface BrandUserContactInfoAssist : CBaseContactInfoAssist <UITableViewDelegate, UITableViewDataSource, UIAlertViewDelegate, IWCDeviceBrandMgrExt, IKFContactMgrExt, IEnterpriseContactMgrExt, ICertInfoMgrExt>
{
...
- (void)makeEnterpriseSubBrandStikyOnTopCell:(id)arg1;
