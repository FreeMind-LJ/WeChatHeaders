...
@class CMessageWrap, FavForwardLogicController, FavoritesItem, NSMutableArray, NSString, NSTimer, NSURL, UIButton, UITextField, UITextView, WNNoteVoiceItemUtil;

@interface WNNoteViewController : WNRichEditViewController <IFavoritesExt, IRecordDownloadExt, WCActionSheetDelegate, FavForwardLogicDelegate, UITextFieldDelegate, FavTagViewDelegate, UIScrollViewDelegate, FavFullScreenImageViewDelegate>
{
    int _footerHeight;
...
@property(nonatomic) _Bool m_edited; // @synthesize m_edited=_m_edited;
