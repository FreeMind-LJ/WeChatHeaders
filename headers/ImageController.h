...
@class CaptureVideoInfo, MMLoadingView, MsgImgFullScreenWindow, NSString, UINavigationController, UIViewController;
...
@property(retain, nonatomic) MsgImgFullScreenWindow *m_imgFullScreenWnd; // @synthesize m_imgFullScreenWnd;
...
- (void)preViewImage:(id)arg1 delegate:(id)arg2;
- (void)Reset;
