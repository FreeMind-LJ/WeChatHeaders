...
@class CBaseContact, CContact, CMessageWrap, CPushContact, MMUIViewController, NSArray, NSString, PushMailWrap;
...
- (void)addEmoticonFailed:(NSString *)arg1;
- (void)addEmoticonOK;
- (void)tagLink:(NSString *)arg1;
...
- (void)tapFriendCard_NodeView:(id)arg1 WithContact:(CContact *)arg2;
