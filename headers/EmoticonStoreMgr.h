...
- (void)setStoreListCacheWithItemList:(id)arg1 Advertisment:(id)arg2 collCellArray:(id)arg3 withReqType:(unsigned int)arg4 withTopNum:(unsigned int)arg5;
- (void)setStoreListCacheWithItemList:(id)arg1 Advertisment:(id)arg2 collCellArray:(id)arg3 withReqType:(unsigned int)arg4;
...
- (id)getStoreCollectionCellListForReqType:(unsigned int)arg1;
...
- (void)onPurchaseFailForProduct:(id)arg1;
- (void)onPurchaseSuccessForProduct:(id)arg1;
