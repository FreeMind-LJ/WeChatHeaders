...
@class AppInnerJumpItem, AppProductItem, AppTVItem, CMessageWrap, CardTicketItem, EmoticonSharedItem, EmotionDesignerSharedItem, FavoritesItem, HardWareItem, MMWCPushInfo, MallProductItem, NSArray, NSMutableDictionary, NSString, WCPayInfoItem, iWatchAppMsgItem;
