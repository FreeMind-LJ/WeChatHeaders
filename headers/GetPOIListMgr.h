...
- (_Bool)getSearchPOIList:(CDStruct_c3b9c2ee)arg1 KeyWord:(id)arg2 StartFromFirst:(_Bool)arg3 Scene:(unsigned int)arg4;
- (_Bool)getNearPOIList:(CDStruct_c3b9c2ee)arg1 StartFromFirst:(_Bool)arg2 Scene:(unsigned int)arg3;
- (void)dealloc;
