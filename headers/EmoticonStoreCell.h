...
@class EmoticonStoreItem, MMProgressView, MMWebImageView, NSString, UIActivityIndicatorView, UIButton, UIImageView, UILabel;

@interface EmoticonStoreCell : MMUIView <IEmoticonPackageMgrExt, IEmoticonPackageStateMgrExt>
{
    long long _type;
    long long _scene;
    ...
    id <EmoticonStoreCellDelegate> m_delegate;
...
@property(nonatomic) __weak id <EmoticonStoreCellDelegate> m_delegate; // @synthesize m_delegate;
