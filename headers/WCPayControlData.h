...
@class CContact, NSArray, NSDate, NSError, NSMutableArray, NSString, TenpayBindCardInfo, TenpayBindCardSubscribeAppInfo, WCPayAppAuthRequestStruct, WCPayAuthenticationPay, WCPayAuthenticationPayStatusStruct, WCPayAuthenticationPayVerifySMSStruct, WCPayBalanceInfo, WCPayBindCardInfo, WCPayBindInfo, WCPayBindUserInfo, WCPayCardBinInfo, WCPayCreditCardInfo, WCPayIAPOrderDetail, WCPayLoanEntryInfo, WCPayMultiOrderDetail, WCPayNoticeInfo, WCPayOfflinePayChangeLimitFeeRequestStruct, WCPayOfflinePayQueryInfo, WCPayOfflinePayQueryInfoRequest, WCPayPayUBalanceInfo, WCPayPayUSwitchInfo, WCPayPayUUserInfo, WCPayResetPasswordInfo, WCPaySwitchInfo, WCPayTransferPrepayRequestStruct, WCPayUserInfo, WCPayVirtualNoBindCard;
...
@interface WCPayControlData : NSObject
{
    ...
    NSString *m_payRef;
    _Bool m_hasPayUMobile;
    NSArray *m_arrPayUQuestion;
    NSString *m_nsPayUSelectQuestion;
    NSString *m_nsPayUSelectQuerstionId;
    NSString *m_nsPayUAnswer;
    NSString *m_payu_bank_type;
    NSString *m_payu_bank_name;
    NSString *m_payu_information;
    NSString *m_payu_name_on_card;
    NSString *m_payu_description;
    NSString *m_payu_bin;
    NSArray *m_payu_bindquery_records;
    WCPayPayUUserInfo *m_payu_user_info;
    WCPayPayUSwitchInfo *m_payu_switch_info;
    WCPayPayUBalanceInfo *m_payu_balance_info;
    NSString *m_payu_app_usrname;
    NSString *m_payu_total_fee;
    NSString *m_payu_fee_type;
    NSString *m_payu_support_type;
    unsigned int m_payu_num;
    NSArray *m_qrcode_use_resp_records;
    NSString *m_payu_trans_id;
    _Bool m_payu_redirect;
    NSString *m_payu_gateway_ref;
    NSString *m_payu_gateway_code;
    NSString *m_payu_pay_status;
    unsigned int m_payu_timestamp;
    NSString *m_payu_pay_status_name;
    NSString *m_payu_transfer_type;
    NSString *m_payu_face_transfer_username;
    NSString *nsPayUContryCode;
    ...
    NSArray *_m_arrBalanceNotice;
    NSArray *_m_arrFetchNotice;
}

@property(nonatomic) _Bool m_bTouchIDAuthOrder; // @synthesize m_bTouchIDAuthOrder=_m_bTouchIDAuthOrder;
@property(retain, nonatomic) NSArray *m_arrFetchNotice; // @synthesize m_arrFetchNotice=_m_arrFetchNotice;
@property(retain, nonatomic) NSArray *m_arrBalanceNotice; // @synthesize m_arrBalanceNotice=_m_arrBalanceNotice;
...
@property(retain, nonatomic) NSString *m_nsPayUSelectQuerstionId; // @synthesize m_nsPayUSelectQuerstionId;
@property(retain, nonatomic) NSString *nsPayUContryCode; // @synthesize nsPayUContryCode;
@property(retain, nonatomic) NSString *m_payu_face_transfer_username; // @synthesize m_payu_face_transfer_username;
@property(retain, nonatomic) NSString *m_payu_transfer_type; // @synthesize m_payu_transfer_type;
@property(retain, nonatomic) NSString *m_payu_pay_status_name; // @synthesize m_payu_pay_status_name;
@property(nonatomic) unsigned int m_payu_timestamp; // @synthesize m_payu_timestamp;
@property(retain, nonatomic) NSString *m_payu_pay_status; // @synthesize m_payu_pay_status;
@property(retain, nonatomic) NSString *m_payu_gateway_code; // @synthesize m_payu_gateway_code;
@property(retain, nonatomic) NSString *m_payu_gateway_ref; // @synthesize m_payu_gateway_ref;
@property(nonatomic) _Bool m_payu_redirect; // @synthesize m_payu_redirect;
@property(retain, nonatomic) NSString *m_payu_trans_id; // @synthesize m_payu_trans_id;
@property(retain, nonatomic) NSArray *m_qrcode_use_resp_records; // @synthesize m_qrcode_use_resp_records;
@property(nonatomic) unsigned int m_payu_num; // @synthesize m_payu_num;
@property(retain, nonatomic) NSString *m_payu_support_type; // @synthesize m_payu_support_type;
@property(retain, nonatomic) NSString *m_payu_fee_type; // @synthesize m_payu_fee_type;
@property(retain, nonatomic) NSString *m_payu_total_fee; // @synthesize m_payu_total_fee;
@property(retain, nonatomic) NSString *m_payu_app_usrname; // @synthesize m_payu_app_usrname;
@property(retain, nonatomic) WCPayPayUBalanceInfo *m_payu_balance_info; // @synthesize m_payu_balance_info;
@property(retain, nonatomic) WCPayPayUSwitchInfo *m_payu_switch_info; // @synthesize m_payu_switch_info;
@property(retain, nonatomic) WCPayPayUUserInfo *m_payu_user_info; // @synthesize m_payu_user_info;
@property(retain, nonatomic) NSArray *m_payu_bindquery_records; // @synthesize m_payu_bindquery_records;
@property(retain, nonatomic) NSString *m_payu_bin; // @synthesize m_payu_bin;
@property(retain, nonatomic) NSString *m_payu_description; // @synthesize m_payu_description;
@property(retain, nonatomic) NSString *m_payu_name_on_card; // @synthesize m_payu_name_on_card;
@property(retain, nonatomic) NSString *m_payu_information; // @synthesize m_payu_information;
@property(retain, nonatomic) NSString *m_payu_bank_name; // @synthesize m_payu_bank_name;
@property(retain, nonatomic) NSString *m_payu_bank_type; // @synthesize m_payu_bank_type;
@property(retain, nonatomic) NSString *m_nsPayUSelectQuestion; // @synthesize m_nsPayUSelectQuestion;
@property(retain, nonatomic) NSArray *m_arrPayUQuestion; // @synthesize m_arrPayUQuestion;
@property(retain, nonatomic) NSString *m_nsPayUAnswer; // @synthesize m_nsPayUAnswer;
@property(nonatomic) _Bool m_hasPayUMobile; // @synthesize m_hasPayUMobile;
@property(retain, nonatomic) NSString *m_payRef; // @synthesize m_payRef;
