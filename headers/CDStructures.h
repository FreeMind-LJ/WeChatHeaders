...
struct ISpeedTestChannel {
    struct CSpeedTestChannel *_field1;
};
...
struct tagAVQualityReportInfo {
    ...
    unsigned short _field130;
    unsigned short _field131;
...
struct tagMMDisturbSetting {
    unsigned int _field1;
    struct tagMMDisturbTimeSpan _field2;
    unsigned int _field3;
    struct tagMMDisturbTimeSpan _field4;
};

struct tagMMDisturbTimeSpan {
    unsigned int _field1;
    unsigned int _field2;
};

struct tagMMGmailInfo;

struct tagMMGmailList {
    unsigned int _field1;
    struct tagMMGmailInfo *_field2;
};
...
struct tagMMModUserInfo {
    unsigned int _field1;
    struct tagSKBuiltinString _field2;
    struct tagSKBuiltinString _field3;
    unsigned int _field4;
    struct tagSKBuiltinString _field5;
    struct tagSKBuiltinString _field6;
    unsigned int _field7;
    unsigned int _field8;
    char *_field9;
    int _field10;
    ...
    char *_field13;
    unsigned int _field14;
    struct tagMMDisturbSetting _field15;
    unsigned int _field16;
    unsigned int _field17;
    char *_field18;
    int _field19;
    ...
    char *_field24;
    unsigned int _field25;
    struct tagMMGmailList _field26;
    char *_field27;
    char *_field28;
    unsigned int _field29;
    unsigned int _field30;
