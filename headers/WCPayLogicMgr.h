...
@class NSDate, NSDictionary, NSMutableArray, NSMutableDictionary, NSString, TenpayCertificate, WCPayAuthenticationPay, WCPayAuthenticationPayVerifySMSStruct, WCPayAvalibleBankCardBinInfo, WCPayBindCardInfo, WCPayBindInfo, WCPayBindInfoSMS, WCPayLocalCachedData, WCPayMsgDB, WCPayNetworkHelper, WCPayResetPasswordInfo;
...
- (void)OnWCToPayUCommonResponse:(id)arg1 Request:(id)arg2;
- (void)OnWCToPayUCommonErrorResponse:(id)arg1 Request:(id)arg2;
...
- (void)OnWCPayPayUGenPrepayErrorResponse:(id)arg1 Request:(id)arg2;
- (void)OnWCPayGenPrepayErrorResponse:(id)arg1 Request:(id)arg2;
- (void)OnWCPayPayUGenPrepayResponse:(id)arg1 Request:(id)arg2;
