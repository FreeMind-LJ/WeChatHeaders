...
@class NSArray, NSMutableArray, NSString, WCCardAcceptCardInfo, WCCardData, WCCardPkgMsg;
...
- (void)onGetAvailableCardInfo:(NSString *)arg1 ErrCode:(int)arg2;
- (void)onWCCardMessageUnreadCountChanged:(WCCardPkgMsg *)arg1;
- (void)onGetSerialNumber:(NSString *)arg1 ErrCode:(int)arg2;
