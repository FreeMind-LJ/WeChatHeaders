...
- (void)onWebSearchDataChanged:(_Bool)arg1;
- (void)handleJSApiFuncOfOpenMsgSession:(id)arg1 withCallBackID:(id)arg2;
- (void)handleJSApiFuncOfBrandServiceSearch:(id)arg1 withCallBackID:(id)arg2;
...
- (void)handleJSApiFuncOfGetDisplayName:(id)arg1 withCallBackID:(id)arg2;
