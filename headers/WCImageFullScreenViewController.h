...
@class MMScrollView, NSArray, NSMutableArray, NSString, UIPageControl, UIView;

@interface WCImageFullScreenViewController : MMUIViewController <UIScrollViewDelegate, scrollViewDelegate, WCImageFullScreenViewContainerDelegate, IVOIPUILogicMgrExt, SessionSelectControllerDelegate, MMExposeViewControllerDelegate>
{
...
@property(nonatomic) id <WCImageFullScreenViewControllerDelegate> m_delegate; // @synthesize m_delegate;
