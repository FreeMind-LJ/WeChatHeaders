...
@class ContactsDataLogic, ContactsPanelView, CreateChatLogic, FTSContactMgr, MMSearchBar, MMTableView, MMUIAlertView, NSMutableArray, NSObject, NSString, UIAlertController, UIButton;

@interface SessionSelectController : MMSearchBarDisplayController <IFTSContactMgrExt, UITableViewDelegate, UITableViewDataSource, CreateChatLogicDelegate, UIAlertViewDelegate, MMSearchBarDelegate, ContactsDataLogicDelegate, ContactsPanelViewDelegate, EnterpriseSessionSelectViewControllerDelegate>
{
    ...
    _Bool m_bShowAllContactBelow;
    _Bool m_bFilterMyContact;
}

@property(retain, nonatomic) NSObject *userData; // @synthesize userData=_userData;
@property(nonatomic) int selectionType; // @synthesize selectionType=m_selectionType;
...
@property(nonatomic) _Bool m_bShowAllContactBelow; // @synthesize m_bShowAllContactBelow;
...
- (void)OnEnterpriseSelectSession:(id)arg1 EnterpriseSessionSelectController:(id)arg2;
...
- (void)makeEnterpriseCell:(id)arg1 contact:(id)arg2;
