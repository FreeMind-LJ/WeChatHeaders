...
@class CAppObserverCenter, CAppViewControllerManager, CMainControll, MMServiceCenter, MMUIWindow, NSRecursiveLock, NSString, ResourceInfo, ResourceMonitor, UILabel, UIWindow;
