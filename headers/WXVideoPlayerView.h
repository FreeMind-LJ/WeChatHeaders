...
@class CMessageWrap, NSString, NSTimer, NSURL, SightIconView, SightPlayerView, UIButton, UIImageView, UILabel;
...
@property(retain, nonatomic) NSTimer *m_updateTimer; // @synthesize m_updateTimer;
