...
@class ContactsDataLogic, ContactsPanelView, CreateChatLogic, FTSContactMgr, MMSearchBar, MMTableView, MMUIAlertView, NSMutableArray, NSObject, NSString, UIAlertController, UIButton, WCRedEnvelopesMultiSelectContactsViewController;
