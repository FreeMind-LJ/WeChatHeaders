...
@class CContact, MMAnimationTipView, MMHeadImageView, MMScrollView, NSMutableArray, NSMutableSet, NSString, RichTextView, ScanQRCodeLogicController, UIButton, UIImageView, UILabel, UIView, WCLikeButton;
