...
- (void)onSendSearchWifiHardDevice:(SearchWiFiHardDeviceResp *)arg1;
...
- (void)onSearchUnauthDeviceResponse:(WCDevice *)arg1 ErrorCode:(int)arg2;
...
- (void)onSendWCDeviceBindUnauthResponse:(WCDevice *)arg1 Error:(NSError *)arg2;
