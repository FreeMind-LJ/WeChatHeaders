...
@class MMTableView, NSMutableArray, NSMutableDictionary, NSString, SimpleImgInfo, UILabel;

@interface MsgFastBrowseView : MMUIView <UITableViewDataSource, UITableViewDelegate>
{
