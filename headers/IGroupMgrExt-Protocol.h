...
@class BaseResponseErrMsg, NSArray, NSString;
...
- (void)OnAddGroupMember:(NSString *)arg1 withStatus:(unsigned int)arg2 memberList:(NSArray *)arg3 contactList:(NSArray *)arg4 Error:(BaseResponseErrMsg *)arg5;
