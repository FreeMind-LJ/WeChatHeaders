...
#import "VOIPNetworkSpeedMgrExt.h"
#import "VOIPVideoToVoiceViewDelegate.h"

@class AVAudioPlayer, AVCaptureVideoPreviewLayer, CContact, MMHDHeadImageView, MMTimer, MMTipsView, NSString, UIButton, UIImageView, UILabel, UIView, VOIPVideoRender, VOIPVideoToVoiceView, VoipDescriptionButton;

@interface VideoVoipTalkingView : MMUIView <MMVoipMinimizeWindowExt, MMTipsViewControllerDelegate, SmallCameraViewDelegate, AVVideoDeviceDelegate, IVOIPModeSwitchExt, IVOIPExt, VOIPNetworkSpeedMgrExt, VOIPVideoToVoiceViewDelegate, UIAlertViewDelegate>
{
    CContact *_contact;
    int _status;
...
@property(nonatomic) _Bool m_hasSwitchToSmall; // @synthesize m_hasSwitchToSmall;
...
@property(retain, nonatomic) UIView *m_smallCameraView; // @synthesize m_smallCameraView;
@property(retain, nonatomic) UILabel *m_remoteNameLabel; // @synthesize m_remoteNameLabel;
@property(retain, nonatomic) UILabel *m_myNameLabel; // @synthesize m_myNameLabel;
@property(retain, nonatomic) MMHDHeadImageView *m_remoteHeadView; // @synthesize m_remoteHeadView;
@property(retain, nonatomic) MMHDHeadImageView *m_localHeadView; // @synthesize m_localHeadView;
@property(retain, nonatomic) UIImageView *m_remoteDefaultView; // @synthesize m_remoteDefaultView;
@property(retain, nonatomic) UIImageView *m_localDefaultView; // @synthesize m_localDefaultView;
@property(retain, nonatomic) UIView *m_flipCameraView; // @synthesize m_flipCameraView;
...
- (void)initTipsView;
- (void)initTimerView;
- (void)initRemoteNameLabel;
- (void)initMyNameLabel;
- (void)initRemoteDefaultRenderView;
- (void)initLocalDefaultRenderView;
- (void)initDeafultRenderView;
...
- (struct CGSize)SmallPeerRenderViewSize;
