...
- (void)SendNewStatReport:(id)arg1 daiReport:(id)arg2 channelReport:(id)arg3 engineReport:(id)arg4;
- (void)SendStatReportRequest;
- (void)SendHeartbeatRequest;
- (void)SendDoubleLinkSwitchRequest;
...
- (void)SetReportData:(id *)arg1 dailReport:(id *)arg2 channelReport:(id *)arg3 engineReport:(id *)arg4;
@end
