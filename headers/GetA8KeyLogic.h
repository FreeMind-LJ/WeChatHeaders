...
@interface GetA8KeyLogic : MMObject <WCPayLogicMgrExt, IJumpEmoticonDetailCgiDelegate, ExtraDeviceLoginMgrExt, IScanBookMgrExt, WCCardDetailViewControllerDelegate, PBMessageObserverDelegate, UIAlertViewDelegate, IWCProductExt, WCProductDetailViewControllerDelegate, IWCDeviceBrandMgrExt, WCBaseControlMgrExt>
{
...
- (void)jumpToDeviceSearchViewControllerWithUserData:(id)arg1;
