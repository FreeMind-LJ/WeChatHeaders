...
@class MMGridView, MMGridViewLayoutHorizontalPagedLTRStrategy, NSArray, NSString, UIPageControl, UIPopoverController, UIView;

@interface MMIconActionSheet : NSObject <UIPopoverControllerDelegate, UIScrollViewDelegate, MMGridViewDataSource, MMGridViewActionDelegate>
{
