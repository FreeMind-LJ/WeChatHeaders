...
@class MMUILabel, NSString, NSTimer, UIButton, UIImageView;
...
- (id)initWithTipsContent:(id)arg1 andIconType:(unsigned int)arg2 andConfirmBtnTitle:(id)arg3 andCancelBtnTitle:(id)arg4 andSessionListLimit:(unsigned int)arg5 andConfirmTimeout:(unsigned int)arg6 andRespType:(long long)arg7 andLoginUrl:(id)arg8 andIsFromScan:(_Bool)arg9;
- (void)dealloc;
