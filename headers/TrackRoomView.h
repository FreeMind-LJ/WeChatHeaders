...
@class AnnotationLogicController, CAShapeLayer, HeadClusterView, MMLoadingView, NSString, NSTimer, NavigateLogicController, POIInfo, QMapView, TrackRoomTopBarView, UIAlertView, UIButton, UIView;

@interface TrackRoomView : MMUIWindow <UIAlertViewDelegate, MMHeadImageAnnotationViewDelegate, ITrackRoomMgrExt, TrackRoomTopBarViewDelegate, QMapViewDelegate, WCActionSheetDelegate, ILocationMgrExt, IWXTalkExt, IAUAudioDeviceExt, UIGestureRecognizerDelegate, NavigateLogicControllerDelegate>
{
