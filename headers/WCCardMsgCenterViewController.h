...
@class MMTableView, MMUIButton, MMUILabel, NSMutableArray, NSMutableDictionary, NSString, UIActivityIndicatorView, UIScrollView;

@interface WCCardMsgCenterViewController : MMUIViewController <UITableViewDataSource, UITableViewDelegate, tableViewDelegate, WCActionSheetDelegate, MMWebImageViewDelegate, WCCardMsgViewDelegate>
{
