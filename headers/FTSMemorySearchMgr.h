...
@class NSArray, NSMutableArray, NSMutableDictionary, NSString, Package;

@interface FTSMemorySearchMgr : NSObject <IMMLanguageMgrExt, MMKernelExt, MMPackageDownloadMgrExt, IGameCenterExt>
{
    _Bool _hasInited;
