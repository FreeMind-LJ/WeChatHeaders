...
@class MFBakChatView, MFMassSendBannerLogic, MFMusicPlayBtn, MFPublicWifiBtn, MFPushBannerLogic, MFPushSystemMsgLogic, MFWebMMBtn, MMVoiceSearchBar, NSMutableArray, NSString;

@interface MainFrameHeaderLogic : MMObject <MFPushBannerDelegate, MFPushSystemMsgDelegate, MFMassSendBannerDelegate, IOnlineClientMgrExt, IMusicPlayerExt, IBakChatUploadMgrExt, IBakChatRecoverMgrExt, IPublicWifiManagerExt>
{
...
- (void)processBakChatView:(_Bool)arg1 WithStatus:(unsigned int)arg2;
- (void)showBakChatViewInDownload;
- (void)showBakChatViewInUpload;
- (void)initBakChatBtn:(unsigned int)arg1;
