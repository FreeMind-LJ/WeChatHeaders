...
@class MMLocationAttributeBanner, MMLocationPinView, MMSearchBar, MMTableView, NSMutableArray, NSString, QMapView, UIAlertView, UIButton, UILabel, UIPinchGestureRecognizer, WCTimeLineFooterView;

@interface MMPickLocationViewController : MMSearchBarDisplayController <UITableViewDelegate, tableViewDelegate, UITableViewDataSource, IGetPOIListMgrExt, ILocationMgrExt, UIGestureRecognizerDelegate, MMRefreshTableFooterDelegate, MMSearchBarDelegate, MMLocationAttributeBannerDelegate, QMapViewDelegate, MMLocationPinViewDelegate, UIAlertViewDelegate, WCActionSheetDelegate>
{
...
- (void)resetPOIList;
- (void)removePOIAtIndex:(unsigned long long)arg1 UpdateTable:(_Bool)arg2 Animated:(_Bool)arg3;
