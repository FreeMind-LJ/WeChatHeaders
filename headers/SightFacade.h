...
@class CMMotionManager, MMObject<SightCaptureLogic>, MMWindowController, MainFrameSightViewController, NSMutableArray, NSMutableDictionary, NSString, SightDraftMgr, UIImage;
...
- (struct CGRect)jumpToMomentTimelineTopAtBackground;
...
- (unsigned int)prepareRecording:(struct CGSize)arg1 bitrate:(double)arg2;
- (void)cancelRecording:(unsigned int)arg1;
- (void)stopRecording:(unsigned int)arg1;
- (unsigned int)startRecording:(struct CGSize)arg1 bitrate:(double)arg2;
