...
#import "NewBindQQViewControllerDelegate.h"
#import "SettingModifyQQViewControllerDelegate.h"

@class MFBannerBtn, NSString;

@interface MFPushBannerLogic : MMObject <SettingModifyQQViewControllerDelegate, NewBindQQViewControllerDelegate, BannerToastExt, IABtestMgrExt, IHeadImageExt, MMKernelExt>
{
