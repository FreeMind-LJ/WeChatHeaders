...
@class CMessageWrap, NSArray, NSSet, NSString;

@protocol IEnterpriseMsgExt

@optional
- (void)OnMsgDownloadAppAttachExpiredFail:(NSString *)arg1 MsgWrap:(CMessageWrap *)arg2 Brand:(NSString *)arg3;
...
- (void)OnAddMsgListForSession:(NSArray *)arg1 NotifyUsrName:(NSSet *)arg2 Brand:(NSString *)arg3;
