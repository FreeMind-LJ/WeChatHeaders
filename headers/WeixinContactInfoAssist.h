...
@class CContact, MMTableViewInfo, NSMutableArray, NSString, UIButton;
...
- (id)initWithContact:(id)arg1 andChatContact:(id)arg2 andVerify:(unsigned int)arg3 delegate:(id)arg4 location:(id)arg5;
