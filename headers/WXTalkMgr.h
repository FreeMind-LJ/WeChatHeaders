...
@class AVAudioPlayer, NSData, NSRecursiveLock, NSString, NSTimer, WXTalkComponent, WXTalkDNSController, WXTalkRoomData, WXTalkStatusReportHelper;
...
@property(retain, nonatomic) NSTimer *wxTalkTimer; // @synthesize wxTalkTimer;
...
@property(retain, nonatomic) WXTalkComponent *component; // @synthesize component;
