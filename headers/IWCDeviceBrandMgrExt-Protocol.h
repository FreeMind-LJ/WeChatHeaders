...
@class BlueProfilePedometerInfo, ModContact, NSArray, NSData, NSDictionary, NSError, NSMutableArray, NSString, WCDevice, WCLanDeviceInfo;

@protocol IWCDeviceBrandMgrExt <NSObject>

@optional
- (void)onReceiveWCLanDeviceDisc:(WCLanDeviceInfo *)arg1 Cmd:(unsigned int)arg2;
...
- (void)onWifiHardDeviceSearch:(ModContact *)arg1 respData:(NSDictionary *)arg2;
- (void)onSearchUnauthDeviceEnd:(WCDevice *)arg1 ErrorCode:(int)arg2;
...
- (void)onWCDeviceBindUnauthEnd:(WCDevice *)arg1 Error:(NSError *)arg2;
- (void)onWCDeviceBindEnd:(NSString *)arg1 Error:(NSError *)arg2;
