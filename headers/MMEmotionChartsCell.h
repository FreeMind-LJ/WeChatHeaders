...
@class EmoticonStoreItem, EmotionProgressView, MMDelegateProxy<MMEmotionChartsCellDelegate>, MMWebImageView, NSString, UIActivityIndicatorView, UIButton, UIImageView, UILabel;
...
@interface MMEmotionChartsCell : MMUIView <IEmoticonPackageMgrExt, IEmoticonPackageStateMgrExt>
{
    ...
    MMDelegateProxy<MMEmotionChartsCellDelegate> *m_delegate;
...
@property(nonatomic) __weak MMDelegateProxy<MMEmotionChartsCellDelegate> *m_delegate; // @synthesize m_delegate;
