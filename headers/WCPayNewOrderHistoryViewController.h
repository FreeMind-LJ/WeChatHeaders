...
@class MMTableView, NSMutableDictionary, NSMutableOrderedSet, NSString;

@interface WCPayNewOrderHistoryViewController : MMUIViewController <UITableViewDelegate, UITableViewDataSource>
{
...
- (void).cxx_destruct;
- (void)PayU_HandleGetOrderResponse:(id)arg1 error:(id)arg2;
