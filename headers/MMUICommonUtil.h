...
+ (id)getBottomBarButtonWithImageName:(id)arg1 target:(id)arg2 action:(SEL)arg3 style:(int)arg4;
...
+ (id)getBarButtonWithImageName:(id)arg1 target:(id)arg2 action:(SEL)arg3 style:(int)arg4;
...
+ (id)getBarButtonBackgroundDisableImage:(int)arg1;
+ (id)getBarButtonBackgroundHLImage:(int)arg1;
+ (void)setBottomBarButtonTitleColor:(id)arg1 withStyle:(int)arg2;
+ (id)getBarButtonBackgroundImage:(int)arg1;
