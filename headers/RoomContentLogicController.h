...
@class ChatRoomInfoSettingMgr, NSString, RoomReportController, TipsView;

@interface RoomContentLogicController : BaseMsgContentLogicController <chatRoomInfoDelegate, chatRoomSettingDelegate, IGroupMgrExt, IContactMgrExt, ShareFriendOnChatDelegate, RoomContactSelectDelegate, IAutoSetRemarkExt, IMMQRCodeExt, TipsViewDelegate, ChatroomMemberRemoveViewControllerDelegate>
{
...
- (void)ViewDidAppear;
- (void)tryGetChatRoomDetail:(id)arg1;
- (void)ClearStatusAndUnRegisterForCacheStatus;
- (void)removeChatRoomTip;
- (void)showChatRoomTip:(unsigned int)arg1;
