...
@class CLLocation, LbsLife, LocationRetriever, MMSearchBar, MMTableView, NSMutableArray, NSString, UILabel, UIView, WCTimeLineFooterView;

@interface WCTimelinePOIPickerViewController : MMSearchBarDisplayController <UITableViewDelegate, tableViewDelegate, UITableViewDataSource, MMRefreshTableFooterDelegate, MMSearchBarDelegate, ILBSLifeMgrExt, LocationRetrieveDelegate, ILocationMgrExt, POICreateDelegate>
{
...
- (void)OnSearchLBSLife:(id)arg1 Keyword:(id)arg2 Error:(int)arg3;
