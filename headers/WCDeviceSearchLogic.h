...
@class NSMutableDictionary, NSMutableSet, NSString, WCDevice, WCDeviceBrandMgr;

@interface WCDeviceSearchLogic : NSObject <IWCDeviceBrandMgrExt>
{
...
- (void)onWifiHardDeviceSearch:(id)arg1 respData:(id)arg2;
- (void)onReceiveWCLanDeviceDisc:(id)arg1 Cmd:(unsigned int)arg2;
...
- (void)connectAndSearchBLEDevice:(id)arg1;
- (void)stopScan;
- (void)startScan;
- (void)dealloc;
